...
var Main = (function(){
		...
		$(window).scroll(function() {
			...
			if(pageWidth>=800){
				if(top === 0 ){
					flag=1;
					$('.left-col').css({left:"0"})
					$('.hide-left').css({"-moz-transform":"scaleX(-1)",
					...
					flag=0;
					$('.left-col').css({left:"-230px"})
					$('.hide-left').css({"-moz-transform":"scaleX(-1)",
														"-webkit-transform":"scaleX(-1)",
														" -o-transform":"scaleX(-1)",
														" transform":"scaleX(-1)"
													})
					$('.mid-col').css({left:"60px"})	
				}
			}
	...
	// var live2dClick = function(){
	// 	console.log('click')
	// 	$('#live2dcanvas').click(function(){
	// 		console.log('click miku~')
	// 	})
	// }
